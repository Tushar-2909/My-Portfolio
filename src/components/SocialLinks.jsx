...
const socialLinks = [
  {
    ...
    subText: "on LinkedIn",
    icon: Linkedin,
    url: "https://www.linkedin.com/in/tushar-gandhwani-202541339/",
    color: "#0A66C2",
  ...
  },
  {
    name: "Gmail",
    displayName: "G-Mail",
    subText: "Tushar Gandhwani",
    icon: Mail,
    url: "mailto:tushargandhwani@gmail.com",
    color: "#E4405F",
  ...
  },
  {
    ...
    subText: "Tushar-2909",
    icon: Github,
    url: "https://github.com/Tushar-2909",
    color: "#ffffff",
...
const SocialLinks = () => {
  const filteredLinks = socialLinks.filter(link => 
    link.name === "LinkedIn" || link.name === "GitHub" || link.name === "Gmail"
  );

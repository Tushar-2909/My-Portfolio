...
const WORDS = ["B.tech Computer Science Student", "Tech Enthusiast"];
const TECH_STACK = ["React", "Javascript", "Node.js", "Tailwind"];
const SOCIAL_LINKS = [
  { icon: Github, link: "https://github.com/Tushar-2909" },
  { icon: Linkedin, link: "https://www.linkedin.com/in/tushar-gandhwani-202541339/" },
  { icon: Mail, link: "mailto:tushargandhwani@gmail.com" }
];
            ...
            <div className="w-full lg:w-1/2 space-y-6 sm:space-y-8 text-left lg:text-left order-1 lg:order-1 lg:mt-0"
              ...
              <div className="space-y-4 sm:space-y-6">
                ...
                <p className="text-base md:text-lg text-gray-400 max-w-xl leading-relaxed font-light"
                  data-aos="fade-up"
                  data-aos-delay="1000">
                  I’m Tushar gandhwani, and I believe great design solves great problems. Explore my work and see how.
                </p>
